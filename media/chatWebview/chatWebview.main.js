...
window.addEventListener("message", (event) => {
	...
	switch (message.type) {
		...
		case "addMessage":
			...
			addMessage(message.id, message.role, message.text ?? "", message.loading ?? false, message.ideContextLabel ?? "", message.slashCommandLabel ?? "", message.secondary === true, message.error === true, message.compaction === true, message.checkpointId ?? "");
			break;
		case "appendMessage":
